...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ServingCategoryDao.createTable(db, ifNotExists);
        ServingSizeDao.createTable(db, ifNotExists);
        FoodDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ServingCategoryDao.dropTable(db, ifExists);
        ServingSizeDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(ServingCategoryDao.class);
        registerDaoClass(ServingSizeDao.class);
